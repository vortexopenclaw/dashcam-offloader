...
enum VerificationTest {
    static func run() -> Bool {
        do {
            ...
            guard KnownDashcamCatalog.models.count >= 180,
                  ...
                  KnownDashcamCatalog.exactModelMention("S1PROMAX_Setting.exe", manufacturer: "Vantrue")?.model == "S1 Pro Max",
                  KnownDashcamCatalog.exactModelMention("Device=N1PRO", manufacturer: "Vantrue")?.model == "N1 Pro",
